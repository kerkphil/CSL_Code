...
options_ = [];
M_.fname = 'varyingMtax_d1';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('varyingMtax_d1.log');
M_.exo_names = 'eps';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('varyingMtax_d1_static');
erase_compiled_function('varyingMtax_d1_dynamic');
...
save('varyingMtax_d1_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('varyingMtax_d1_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('varyingMtax_d1_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('varyingMtax_d1_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('varyingMtax_d1_results.mat', 'estimation_info', '-append');
end
