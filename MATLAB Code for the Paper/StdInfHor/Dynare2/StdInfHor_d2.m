...
options_ = [];
M_.fname = 'StdInfHor_d2';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('StdInfHor_d2.log');
M_.exo_names = 'eps';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('StdInfHor_d2_static');
erase_compiled_function('StdInfHor_d2_dynamic');
...
oo_.steady_state( 4 ) = 1.665;
oo_.steady_state( 5 ) = 0.0917;
oo_.steady_state( 1 ) = 1.337;
oo_.steady_state( 2 ) = 7.855;
...
save('StdInfHor_d2_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('StdInfHor_d2_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('StdInfHor_d2_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('StdInfHor_d2_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('StdInfHor_d2_results.mat', 'estimation_info', '-append');
end
