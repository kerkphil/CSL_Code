...
% longer simulation for standard infinite horizon model
%-------------------------------------------------------------------------%
% This program calls the following .mod and .mat file(s)
%     * StdInfHor_d2.mod: runs the dynare .mod file for the 2nd order
%          approximation
%     * StdInfHorParams.mat: loads common parameter values into memory
%     * StdInfHor_vfi.mat: loads in capital paths from VFI IRF1, IRF2, and
%          simulation
%-------------------------------------------------------------------------%
...
%-------------------------------------------------------------------------%
clear ;
%cd('/Users/rwe2/Documents/BYU Economics/Paper Ideas/CSL/MatLab/StdInfHor/Dynare2') ;
...
%-------------------------------------------------------------------------%
dynare StdInfHor_d2.mod noclearall ;
...
load '../VFI/StdInfHor_vfi.mat' kirfvec_vfi1 kirfvec_vfi2 ksimvec_vfi3 ;
zsize = length(zvec) ;
