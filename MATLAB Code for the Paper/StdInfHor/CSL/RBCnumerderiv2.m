function [AA, BB, CC, DD, FF, GG, HH, JJ, KK, LL, MM, TT] = RBCnumerderiv2(funcname,theta0,nx,ny,nz)
...
incr = .0001;    %increment to use in calculating numerical derivatives
