...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('InfHorDyn2_static');
erase_compiled_function('InfHorDyn2_dynamic');
...
M_.params( 5 ) = 1;
lbar = M_.params( 5 );
M_.params( 6 ) = 0.8145062499999999;
crho = M_.params( 6 );
M_.params( 7 ) = 0.0130058759370760;
csigma = M_.params( 7 );
%
...
save('InfHorDyn2_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('InfHorDyn2_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('InfHorDyn2_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('InfHorDyn2_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('InfHorDyn2_results.mat', 'estimation_info', '-append');
end
