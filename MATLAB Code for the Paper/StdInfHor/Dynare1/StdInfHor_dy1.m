...
%     * StdInfHor_d1.mod: runs the dynare .mod file for the 1st order
%          approximation
...
%-------------------------------------------------------------------------%
clear ;
%cd('/Users/rwe2/Documents/BYU Economics/Paper Ideas/CSL/MatLab/StdInfHor/Dynare1') ;
...
%-------------------------------------------------------------------------%
dynare StdInfHor_d1.mod noclearall ;
a0 = oo_.dr.ys(2,1) ;
a1 = oo_.dr.ghx(2,1) ;
a2 = oo_.dr.ghx(2,2) ;
a3 = oo_.dr.ghu(2,1) ;
