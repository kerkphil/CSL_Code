%-------------------------------------------------------------------------%
% Compute solutions and IRFs to growth model with three steady-states
%-------------------------------------------------------------------------%
% This program calls the following .m, .mod, and .mat file(s)
%     * unstab_par.m: Loads the parameters across models into memory
%     * unstab_vfi.m: Policy function iteration solution file
...
%-------------------------------------------------------------------------%
clear ;
%cd('/Users/rwe2/Documents/BYU Economics/Paper Ideas/CSL/MatLab/unstab') ;
...
run('../unstab/ParamSet/unstab_par.m') ;

% Run value function iteration solution
run('../unstab/VFI/unstab_vfi.m') ;
