...
options_ = [];
M_.fname = 'ClosedForm_d2';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('ClosedForm_d2.log');
M_.exo_names = 'eps';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('ClosedForm_d2_static');
erase_compiled_function('ClosedForm_d2_dynamic');
...
save('ClosedForm_d2_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('ClosedForm_d2_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('ClosedForm_d2_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('ClosedForm_d2_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('ClosedForm_d2_results.mat', 'estimation_info', '-append');
end
