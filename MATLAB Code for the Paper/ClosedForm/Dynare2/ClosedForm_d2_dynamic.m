function [residual, g1, g2, g3] = ClosedForm_d2_dynamic(y, x, params, steady_state, it_)
%
...
residual(4)= lhs-rhs;
lhs =y(5);
rhs =params(4)*y(2)+(1-params(4))*params(3)+x(it_, 1);
residual(5)= lhs-rhs;
if nargout >= 2,
  g1 = zeros(5, 10);
...
if nargout >= 3,
  ...
  v2(1,1)=1;
  v2(1,2)=56;
  v2(1,3)=(y(6)+y(6))/(y(6)*y(6)*y(6)*y(6));
  v2(2,1)=1;
  v2(2,2)=78;
  v2(2,3)=(-((-((-(params(2)*y(9)))*(y(8)+y(8))))/(y(8)*y(8)*y(8)*y(8))));
  v2(3,1)=1;
  v2(3,2)=88;
  v2(3,3)=(-((-params(2))/(y(8)*y(8))));
  v2(4,1)=1;
  v2(4,2)=79;
  v2(4,3)=  v2(3,3);
  v2(5,1)=2;
